...
class Form extends Component {
    ...
    componentDidUpdate(prevProps){
        // always compare prev with current
        ...
        return (  
            ...
            <div className={classes.form}>
                ...
                <div className={classes.uploadContainer}>
                    <img src={this.state.selectedUser.picture.large === "" ? upload : this.state.selectedUser.picture.large} alt="upload here" className={this.state.largeError ? classes.redUploadDisplay : classes.uploadDisplay} onClick={this.clickFile}></img>
